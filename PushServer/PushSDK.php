...
use BaiduBundle\PushBundle\PushServer\BaseSDK;
...
//require_once PUSH_SDK_HOME . '/BaseSDK.php';
...
class PushSDK extends BaseSDK {
	 ...
	 * @param $deviceType;1ios2Android
     */
    function __construct($deviceType=2, $apiKey = null, $secretKey = null, $curlopts = array()) {
        ...
        if($apiKey !== null && $secretKey !== null){
			...
			if($deviceType==1){
				...
				$this -> setApiKey(BAIDU_PUSH_CONFIG::default_apiKey_ios);
				$this -> setSecretKey(BAIDU_PUSH_CONFIG::default_secretkey_ios);
